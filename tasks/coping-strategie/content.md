...
:::Stav: Obsahový podklad; při rozporu má přednost aktuální Figma
...
Pokud v sekci **Vybrané** nebo **Další strategie** není žádná položka, nevykreslí
se její nadpis ani prázdný seznam. Samostatný vysvětlující text se nezobrazuje.

**Skryté strategie**

Odkaz i seznam se zobrazí až ve chvíli, kdy existuje alespoň jedna skrytá
strategie.

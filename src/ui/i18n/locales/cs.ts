...
export const cs = {
  ...
  'review.status.OK': 'OK',
  'review.status.POZOR': 'POZOR',
  'review.status.PREKROCENO': 'PŘEKROČENO',
  'review.status.NEUPLNE': 'NEÚPLNÉ',
  'review.tabs.aria': 'Hlavní navigace',
  'review.tabs.home': 'Domů',
  'review.tabs.coping': 'Váš Coping',
  'review.tabs.reports': 'Přehledy',

...
export const cs = {
  ...
  'onboarding.intro.title': 'Získejte přehled o svém hraní',
  'onboarding.intro.lead':
    '28 dní si budete zapisovat, kolik času a peněz jste hraní věnovali. Aplikace vám na základě toho navrhne týdenní limity a každý den vám řekne, jak si vedete.',
  'onboarding.intro.bullet.checkin': 'Zapsat denní pokrok zabere pár sekund',
  'onboarding.intro.bullet.local': 'Data zůstávají pouze ve vašem telefonu',
  'onboarding.intro.bullet.export': 'Kdykoliv si můžete prohlédnout svůj pokrok',
  'onboarding.intro.disclaimer.title': 'Nejedná se o náhradu odborné léčby',
  'onboarding.intro.disclaimer.body':
    'Aplikace nenahrazuje odbornou léčbu ani krizovou pomoc. Jestliže potřebujete akutní pomoc, můžete se například obrátit na služby krizových linek uvedených v sekci Vaše strategie.',
  'onboarding.intro.cta': 'Začít',

  'onboarding.refTime.overline': 'Nastavte svůj referenční týden',
  'onboarding.refTime.title': 'Kolik času věnujete hraní hazardních her během týdne?',
  'onboarding.refTime.lead':
    'Stačí odhad. Je to výchozí stav, se kterým aplikace porovnává vaše denní záznamy.',
  'onboarding.refTime.time.label': 'Čas za týden',
  ...
  'onboarding.refTime.disclaimer.body':
    'Zadaná hodnota se uloží jako reference počátečního stavu, která zůstane stejná po celé další 4 týdny.',

  'onboarding.refStakes.overline': 'Nastavte svůj referenční týden',
  'onboarding.refStakes.title': 'Kolik peněz celkem během jednoho týdne vsadíte?',
  'onboarding.refStakes.lead': 'Zajímá nás celková vsazená částka.',
  ...
  'onboarding.refStakes.why.body':
    'Výši sázek ovlivníte přímo, výsledek hry ne. Týdenní limit se proto váže na vsazenou částku. Výhry si zapisujete jen kvůli výpočtu čisté ztráty.',

  'onboarding.limits.title': 'Nastavení limitů na týden 1',
  'onboarding.limits.lead':
    'Doporučujeme 80 % vašeho běžného týdne. Limit můžete snížit, nebo zvýšit — nejvýš ale na 90 % reference.',
  'onboarding.limits.time.label': 'Čas za týden',
  'onboarding.limits.time.sub': 'z {reference}',
  'onboarding.limits.time.note': '80 % z {reference} min · strop {cap} min ({capHours} h)',
  'onboarding.limits.stakes.label': 'Sázky za týden',
  'onboarding.limits.footnote':
    'Na začátku každého dalšího týdne si budete moci svůj týdenní limit upravit.',
  ...
  'onboarding.coping.title': 'Co uděláte, když budete chtít hrát?',
  ...
  'onboarding.coping.selectedNote.one': 'Vybráno: {count} strategie',
  'onboarding.coping.selectedNote.few': 'Vybráno: {count} strategie',
  'onboarding.coping.selectedNote.other': 'Vybráno: {count} strategií',
  ...
  'onboarding.done.banner.body': 'Každý den se počítá, nezapomeňte si zítra zapsat Váš pokrok.',
  ...
  'review.cap.title': 'Limity se nepřepisují',
  'review.cap.body': 'Každý týden má vlastní záznam — předchozí limity zůstávají uložené.',

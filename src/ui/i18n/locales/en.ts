...
export const en: Record<TranslationKey, string> = {
  ...
  'review.status.OK': 'OK',
  'review.status.POZOR': 'CAUTION',
  'review.status.PREKROCENO': 'EXCEEDED',
  'review.status.NEUPLNE': 'INCOMPLETE',
  'review.tabs.aria': 'Main navigation',
  'review.tabs.home': 'Home',
  'review.tabs.coping': 'Your Coping',
  'review.tabs.reports': 'Reports',
